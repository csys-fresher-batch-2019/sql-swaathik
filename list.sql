create table list(
task_no number,task_name varchar2(50) not null,emp_name varchar2(50) not null,deadline date,completed_date date,status varchar2(10),constraint task_no_uq unique(task_no)
);
